    ...
    <div class="flex flex-col h-screen bg-white overflow-hidden">
        ...
        <nav class="terminal-nav flex items-center justify-between shrink-0 border-b border-gray-100 bg-white sticky top-0 z-[100] px-4 md:px-8 h-20">
            ...
            <div class="flex items-center gap-2 md:gap-4 h-full">
                <button onclick="actions.setHubPanel('notifications')" class="p-2.5 text-gray-400 hover:text-gov-blue hover:bg-gov-light rounded-full transition-all relative">
                ...
                <div class="nav-item hidden lg:flex">
                    <div class="flex items-center gap-4 cursor-pointer p-2.5 hover:bg-gov-light rounded-xl transition-all">
                        <div class="text-right">
                            <div class="text-[10px] font-black text-gov-text leading-none uppercase italic">${char.first_name}</div>
                            <div class="text-[8px] font-bold text-gray-400 uppercase tracking-widest mt-1">${char.job || 'CIVIL'}</div>
                        </div>
