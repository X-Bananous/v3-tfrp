            ...
            <div class="animate-in pb-32 space-y-12 max-w-6xl mx-auto">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div class="bg-white p-8 rounded-[48px] border border-gray-100 shadow-xl flex flex-col">
                        ...
                        <div class="space-y-4">
                            <div class="flex items-start gap-4 p-4 bg-pink-50 rounded-2xl border border-pink-100 group hover:border-pink-300 transition-all">
                                <div class="w-8 h-8 rounded-lg bg-pink-500 text-white flex items-center justify-center shrink-0 shadow-lg shadow-pink-900/10"><i data-lucide="rocket" class="w-4 h-4"></i></div>
                            ...
                            <div class="flex items-start gap-4 p-4 bg-blue-50 rounded-2xl border border-blue-100 group hover:border-blue-300 transition-all">
                                <div class="w-8 h-8 rounded-lg bg-blue-500 text-white flex items-center justify-center shrink-0 shadow-lg shadow-blue-900/10"><i data-lucide="star" class="w-4 h-4"></i></div>
                            ...
                            <div class="flex items-start gap-4 p-4 bg-emerald-50 rounded-2xl border border-emerald-100 group hover:border-emerald-300 transition-all">
                                <div class="w-8 h-8 rounded-lg bg-emerald-500 text-white flex items-center justify-center shrink-0 shadow-lg shadow-emerald-900/10"><i data-lucide="check-circle" class="w-4 h-4"></i></div>
                                <div><div class="text-xs font-black text-emerald-700 uppercase">Succès In-Game</div><p class="text-[10px] text-emerald-600/70 font-medium">Clés périodiques pour les citoyens les plus actifs.</p></div>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        ${[...Array(Math.max(6, turns)).keys()].map(i => {
                            ...
                            return `
                                <button onclick="${canOpen ? `actions.openCrate(${i})` : ''}" 
                                    ...
                                    ${canOpen ? 'bg-white border-gray-50 hover:border-gov-blue hover:shadow-2xl hover:-translate-y-1' : 'bg-gray-100 border-gray-100 opacity-50 cursor-not-allowed'}
                                    ${isTarget ? 'bg-blue-50 border-gov-blue shadow-blue-900/20 animate-pulse' : ''}">
                                    
                                    <div class="w-16 h-16 rounded-2xl bg-gov-light flex items-center justify-center text-gray-400 border border-gray-100 shadow-inner group-hover:text-gov-blue group-hover:scale-110 transition-transform">
                                        <i data-lucide="package" class="w-8 h-8"></i>
                                    </div>
                                    <div class="text-[10px] font-black text-gray-500 uppercase tracking-widest group-hover:text-gov-text transition-colors">
                ...
                <div class="bg-white p-10 rounded-[48px] border border-gray-100 shadow-xl overflow-hidden">
                    <h4 class="text-[10px] font-black text-gray-400 uppercase tracking-[0.4em] mb-8">Contenu potentiel des Lootbox</h4>
