...
export const LoginView = () => {
    ...
    <div class="flex-1 flex flex-col bg-white overflow-y-auto custom-scrollbar">
        ...
        <!-- SERVER STATUS -->
        <section class="py-16 bg-white border-b border-gray-100 px-6">
        ...
        <!-- STAFF -->
        <section class="landing-section bg-white border-b border-gray-100 px-6">
            <div class="max-w-6xl mx-auto text-center">
                <h2 class="text-3xl font-black uppercase tracking-tighter italic mb-16 underline decoration-gov-red decoration-4 underline-offset-8 text-gov-text">Corps Administratif</h2>
                <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-12">
                    ${sortedStaff.map(s => `
                        <div class="group flex flex-col items-center">
                            <div class="relative mb-6">
                                <img src="${s.avatar_url}" class="w-20 h-20 rounded-full border-4 border-white shadow-xl grayscale group-hover:grayscale-0 transition-all duration-500">
                            ...
                            <div class="font-black uppercase text-gov-text tracking-tighter text-sm">${s.username}</div>
                        </div>
                    `).join('')}
                </div>
            </div>
